                                                                ...
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <ol>
                                                                        <li><strong>Confirm Your Acceptance:</strong>
                                                                            ...
                                                                            before {{ $student['deadline_date'] }} by
                                                                            visiting our admissions portal <a
                                                                                href="{{ $student['portal_link'] }}">here</a>.
                                                                        </li>
                                                                        <li><strong>Visit Us:</strong> Consider visiting
                                                                            our Agbani campus to meet future classmates
                                                                            and professors and get a feel for the campus
                                                                            atmosphere. The ESUT ODL Office is located
                                                                            Inside ESUT Opposite ESUT PG School – as you
                                                                            enter the school from the main-gate.</li>
                                                                        <li><strong>Prepare Your Documents:</strong>
                                                                            Ensure that all necessary paperwork, which
                                                                            includes O’Level Result & Passport
                                                                            Photograph to help you complete your
                                                                            registrations by the required deadlines.
                                                                        </li>
                                                                    </ol>
                                                                    ...
                                                                    <div style="margin-top:10px; margin-bottom: 15px;">
                                                                        <p style="margin: 0">Prof. Leonard Anigbo</p>
                                                                        <p style="margin: 0"><b>(ESUT ODL Director)</b>
                                                                        </p>
                                                                        <p style="margin: 0">+234 806 354 3596</p>
                                                                    </div>
                                                                    <div style="margin-bottom: 15px;">
                                                                        <p style="margin: 0">Ass. Prof. Okwuchukwu Ani
                                                                        </p>
                                                                        <p style="margin: 0"><b>(ESUT ODL Deputy
                                                                                Director)</b></p>
                                                                        <p style="margin: 0">+234 803 264 2325</p>
                                                                    </div>
                                                                    <div style="margin-bottom: 15px;">
                                                                        <p style="margin: 0">ODL Technical Unit</p>
                                                                        <p style="margin: 0"><b>(ESUT ODL ICT
                                                                                Support)</b></p>
                                                                        <p style="margin: 0">+234 704 491 4032</p>
                                                                    </div>
                                                                    </p>
                                                                </td>
                                                            </tr>
